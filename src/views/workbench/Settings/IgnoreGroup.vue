...
import AddIgnoreGroup from '@/views/workbench/Settings/components/AddIgnoreGroup.vue'
...
<template>
  <div class="tab-wrap">
    ...
    >
      ...
      <el-table-column align="center" label="群名称">
        <template #default="scope">{{ scope.row.id }}</template>
      </el-table-column>
      <el-table-column align="center" property="address" label="监控机器人">
  ...
  <!-- 添加监控群 -->
  <AddIgnoreGroup v-if="showAddGroup" v-model="showAddGroup"></AddIgnoreGroup>
  <!-- 导入屏蔽群 -->
